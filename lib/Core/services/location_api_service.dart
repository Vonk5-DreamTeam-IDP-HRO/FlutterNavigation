...
class LocationApiService implements ILocationApiService {
  ...
  Future<List<Location>> getAllLocations() async {
    ...
    try {
      ...
      if (response.statusCode == 200 && response.data is List) {
        ...
        debugPrint(
          '[LocationApiService] Failed to load locations: ${response.statusCode}, Data: ${response.data}',
        );
      ...
      debugPrint(
        '[LocationApiService] Unexpected error in getAllLocations: $e',
      );
      throw LocationApiException(
  ...
  Future<LocationDetails> getLocationById(int id) async {
    ...
    final String fullUrl = '${AppConfig.tempRESTUrl}/$endpoint';
    debugPrint(
      '[LocationApiService] Fetching location by ID $id from: $fullUrl',
    );
    ...
    try {
      ...
      if (response.statusCode == 200 && response.data != null) {
        ...
        debugPrint(
          '[LocationApiService] Failed to load location $id: ${response.statusCode}, Data: ${response.data}',
        );
        throw LocationApiException(
          'Failed to load location $id: ${response.statusCode}',
          statusCode: response.statusCode,
          errorData: response.data,
        );
      }
      ...
      debugPrint(
        '[LocationApiService] Unexpected error in getLocationById for $id: $e',
      );
      if (e.toString().contains("parameter 'category' isn't defined")) {
        throw LocationApiParseException(
          'Error parsing LocationDetails for ID $id due to category issue: ${e.toString()}',
          stackTrace: s,
          originalException: e,
        );
      }
  ...
  Future<List<Location>> getLocationsByType(String category) async {
    final String endpoint =
        'api/Location/ByType/$category'; // Assuming this endpoint structure
    final String fullUrl = '${AppConfig.tempRESTUrl}/$endpoint';
    debugPrint(
      '[LocationApiService] Fetching locations by type $category from: $fullUrl',
    );
    ...
    try {
      ...
      if (response.statusCode == 200 && response.data is List) {
        ...
        debugPrint(
          '[LocationApiService] Failed to load locations for category $category: ${response.statusCode}, Data: ${response.data}',
        );
        throw LocationApiException(
      ...
      debugPrint(
        '[LocationApiService] Unexpected error in getLocationsByType for $category: $e',
      );
      throw LocationApiException(
        'An unexpected error occurred: ${e.toString()}',
        stackTrace: s,
  ...
  Future<LocationDetails> createLocation(CreateLocationPayload payload) async {
    ...
    final String fullUrl = '${AppConfig.tempRESTUrl}/$endpoint';
    debugPrint(
      '[LocationApiService] Creating location at: $fullUrl with payload: ${payload.toJson()}',
    );
    ...
    try {
      ...
      if (response.statusCode == 201 && response.data != null) {
        ...
        debugPrint(
          '[LocationApiService] Failed to create location: ${response.statusCode}, Data: ${response.data}',
        );
        throw LocationApiException(
      ...
      if (e.toString().contains("parameter 'category' isn't defined")) {
        throw LocationApiParseException(
          'Error parsing created LocationDetails due to category issue: ${e.toString()}',
          stackTrace: s,
          originalException: e,
        );
      }
  ...
  Future<LocationDetails> updateLocation(
    ...
    final String fullUrl = '${AppConfig.tempRESTUrl}/$endpoint';
    debugPrint(
      '[LocationApiService] Updating location $id at: $fullUrl with payload: ${payload.toJson()}',
    );
    ...
    try {
      ...
      if (response.statusCode == 200 && response.data != null) {
        ...
        debugPrint(
          '[LocationApiService] Failed to update location $id: ${response.statusCode}, Data: ${response.data}',
        );
        throw LocationApiException(
      ...
      debugPrint(
        '[LocationApiService] Unexpected error in updateLocation for $id: $e',
      );
      throw LocationApiException(
        'An unexpected error occurred: ${e.toString()}',
        stackTrace: s,
  ...
  Future<void> deleteLocation(int id) async {
    ...
    try {
      ...
      if (response.statusCode != 204) {
        debugPrint(
          '[LocationApiService] Failed to delete location $id: ${response.statusCode}, Data: ${response.data}',
        );
        throw LocationApiException(
          'Failed to delete location $id: ${response.statusCode}',
          statusCode: response.statusCode,
          errorData: response.data,
        );
      }
      ...
      debugPrint(
        '[LocationApiService] Unexpected error in deleteLocation for $id: $e',
      );
      throw LocationApiException(
        'An unexpected error occurred: ${e.toString()}',
        stackTrace: s,
